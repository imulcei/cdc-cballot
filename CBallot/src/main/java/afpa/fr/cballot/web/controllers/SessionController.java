...
public class SessionController {
     ...
     * @return
     * 
     * transmet la liste de stagiaire pour permettre de choisir les stagiaires, pour 
     * la session
     */
    @GetMapping
     ...
     */
    @PostMapping
    public ResponseEntity<?> createSessionWithStudents(@RequestBody SessionDTO dto) {
